      ...
      <div style="max-width: 1200px; margin: 0 auto;">
        ...
        <a-card style="margin-bottom: 24px;">
          <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
            <a-input-search v-model:value="searchKeyword" placeholder="搜索模板编码、名称或服务商" allow-clear style="width: 300px;"
              @search="handleSearch" />
        ...
        <!-- 模版列表卡片 -->
        <a-card>
          <a-table :columns="columns" :data-source="filteredTemplates" :pagination="pagination" row-key="id"
